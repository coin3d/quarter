...
static QMap<Qt::Key, SoKeyboardEvent::Key> * keyboardmap = NULL;
static QMap<Qt::Key, SoKeyboardEvent::Key> * keypadmap = NULL;

static void init_keymaps(void)
{
  // FIXME: delete these on exit (20070306 frodo)
  keyboardmap = new QMap<Qt::Key, SoKeyboardEvent::Key>;
  keypadmap = new QMap<Qt::Key, SoKeyboardEvent::Key>;
...
KeyboardHandler::translateEvent(QEvent * event)
{
  ...
  case QEvent::KeyRelease:
    return this->keyEvent((QKeyEvent *) event);
  default:
    return NULL;
  }
}
...
const SoEvent * 
KeyboardHandler::keyEvent(QKeyEvent * qevent)
{
